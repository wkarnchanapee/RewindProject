...
public class DialogueTrigger : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            GameController.main.narrativeStage = toNarrativeStage;
        }
    }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.tag == "Player" && triggered == false && GameController.main.keys == runAtKeyStage)
        {
            //Text text = GameController.main.textBox;
            //text.text = str[0];
